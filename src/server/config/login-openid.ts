...
module.exports = (req: any, res: any) => {
    ...
    console.info('$login => ' +  req.session.passport.user._json.name + ' logged in');
...
function makeToken(profile: any, req: any): any {
    let groupIds: any;
    let user: any = req.session.passport.user._json;
    if (user) {
   ...
   // profile.access = t.access;
    ...
    let algorithm: any = 'aes-256-ctr';
    let password: any = 'd6F3Efeq';
